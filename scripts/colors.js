...
define([
  ...
  const ColorSpaces = exports.ColorSpaces = {
    XYZ: 0,
    LAB: 1,
    RGB: 2
  };
  ...
  exports.xyz_to_intensity = function (x, y, z) {
  ...
  exports.xyz_to_saturation = function (x, y, z) {
    let avg = (x + y + z)/3.0;
  ...
  let xyz_colordis = exports.xyz_colordis = function xyz_colordis(c1, c2) {
  ...
  let lab_to_intensity = exports.lab_to_intensity = function (l, a, b) {
    return l;
  }

  let lab_to_saturation = exports.lab_to_saturation = function(l, a, b) {
  ...
  exports.palette_from_image = function (maxcolor = PAL_COLORS*24) {
    exports.colors.length = 0;
  ...
  exports.gen_colors = function gen_colors() {
    ...
    for (let i = 0; i < colors.length; i++) {
      let c = colors[i];
      c = exports.internal_to_rgb(c[0], c[1], c[2]);
  ...
  exports.gen_colors_intern = function gen_colors_intern() {
    ...
    for (let i = 0; i < colors.length; i++) {
      let c = colors[i];
      let c2 = exports.rgb_to_internal(c[0], c[1], c[2]);
  ...
  let lab_saturation = exports.lab_saturation = function lab_saturation(l, a, b) {
  ...
  let rgb_colordis = exports.rgb_colordis = function rgb_colordis(c1, c2) {
  ...
  let old_rgb_colordis = exports.old_rgb_colordis = function old_rgb_colordis(c1, c2) {
  ...
  exports.closest_color2 = function closest_color2(f, c1, nextout, ditherfac) {
    ...
    for (let i = 0; i < colors.length; i++) {
      ...
      for (let j = 0; j < colors.length; j++) {
        ...
        dis = exports.colordis(c1, c4, ditherfac);
  ...
  */
  ...
  exports.closest_color = function closest_color(c1, nextout, ditherfac, not_diffusing) {
    ...
    for (let i = 0; i < colors.length; i++) {
      let c2 = colors[i];
      let dis = not_diffusing ? colordis_not_diffusing(c1, c2) : exports.colordis(c1, c2);
  ...
  */
  ...
  exports.rgb_to_saturation = function (r, g, b) {
  ...
  exports.pushColorSpace = function(space) {
    spacestack.push(colorspace);
    exports.setColorSpace(space);
  }

  exports.popColorSpace = function() {
  ...
  exports.setColorSpace = function setColorSpace(space) {
    colorspace = space;

    switch (space) {
      case ColorSpaces.XYZ:
        exports.rgb_to_internal = exports.rgb_to_xyz;
        exports.internal_to_rgb = exports.xyz_to_rgb;
        exports.internal_to_intensity = exports.xyz_to_intensity;
        exports.internal_to_saturation = exports.xyz_to_saturation;
        exports.colordis = xyz_colordis;
        break;
      case ColorSpaces.LAB:
        exports.rgb_to_internal = exports.rgb_to_lab;
        exports.internal_to_rgb = exports.lab_to_rgb;
        exports.internal_to_intensity = exports.lab_to_intensity;
        exports.internal_to_saturation = exports.lab_to_saturation;
        exports.colordis = lab_colordis;
        break;
      case ColorSpaces.RGB:
        exports.rgb_to_internal = rgb_to_rgb;
        exports.internal_to_rgb = rgb_to_rgb;
        exports.internal_to_intensity = exports.rgb_to_intensity;
        exports.internal_to_saturation = exports.rgb_to_saturation;
        exports.colordis = rgb_colordis;
        break;
    }
  }

  exports.setColorSpace(ColorSpaces.XYZ);
